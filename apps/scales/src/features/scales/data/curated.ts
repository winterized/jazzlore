...
export const CURATED_SCALES: readonly CuratedScale[] = [
  ...
  { id: 'bebop-dominant',      name: 'Bebop dominant',                                    family: 'bebop', intervalDisplay: ['1','2','3','4','5','6','♭7','7'],                 semitones: [0,2,4,5,7,9,10,11], group: '7', groupOrder: 2, description: 'Mixolydian with a chromatic passing tone between 1 and ♭7', theoryTag: 'The classic bop scale over V7' },
