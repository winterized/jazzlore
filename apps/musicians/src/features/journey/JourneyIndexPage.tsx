  ...
  return (
    <Shell>
      ...
      <main>
        ...
        >
          {entries.map((e) => (
            // The <li> uses `display: contents` to participate directly
            // in the parent grid. Pre-2023 WebKit / Chromium / Firefox
            // engines dropped the listitem role under display:contents;
            // all current engines restore it (and project eslint
            // jsx-a11y/no-redundant-roles forbids spelling it out).
            <li key={e.slug}>
              <Link
