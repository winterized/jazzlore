// No-photo figure data + resolver — the React-free half of the no-photo
// feature, split out of `noPhotoFigures.tsx` so that component file exports
// only a component (fast-refresh hygiene; GH #134). The `<NoPhotoMark>`
// component lives in `./noPhotoFigures.tsx` and consumes `FIG_LIB` / `figKey`
// from here. See that file's header for the design-handoff provenance.
